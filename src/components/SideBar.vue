<template>
  <div class="bg-[rgba(241,243,244,1)] w-[290px] h-full flex flex-col justify-between p-2">
    <!-- 新建对话 -->
    <div class="w-full">
      <button
      ...
      <ScrollAreaViewport class="w-full h-full rounded">
        <div class="w-full flex flex-col">
          <div
            ...
            :key="item.id"
            class="w-full flex flex-row items-center gap-1 hover:bg-gray-200 cursor-pointer px-1 py-2"
